...
public class LoggingAspect {
     ...
     * annotation @LogExecutionTime @see com.example.jwt.logging.LogExecutionTime
     *
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.jpa.test.logging.LogExecutionTime)")
